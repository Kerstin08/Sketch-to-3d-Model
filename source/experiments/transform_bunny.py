...
depth_img_ref = mi.render(scene, seed=0, spp=256, integrator=depth_integrator_lodaded)
normal_img_ref = mi.render(scene, seed=0, spp=256, integrator=normal_integrator_lodaded)
...
for it in range(10):
    ...
    depth_img = mi.render(scene, params, seed=it, spp=1, integrator=depth_integrator_lodaded)
    normal_img = mi.render(scene,  params, seed=it, spp=1, integrator=normal_integrator_lodaded)
