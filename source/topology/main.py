...
import source.util.sketch_preprocess_operations as sketch_preprocess

def run(image_path, genus_dir, output_dir):
    if not os.path.exists(output_dir):
        dir_utils.create_general_folder(output_dir)
    image = sketch_preprocess.load_image(image_path, True)
...
def main(args):
    ...
    parser.add_argument("--output_dir", type=str, default='..\\..\\filled', help="Path to the directory where the resulting exr and possible png sould be stored.")
